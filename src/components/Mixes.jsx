...
const mixesData = [
  ...
  { id: 42, title: 'Toad Sovereign',      date: 'MAY 19, 2026', time: '61 MIN', image: '/toadsovereign-img.jpg',   link: 'https://www.youtube.com/watch?v=DQWfczcyKRA'          },
...
export default function Mixes() {
  ...
  return (
    <section id="mixes" style={{ backgroundColor: '#FFEEE8' }} className="max-md:pt-[150px] md:pt-[320px] pb-24 overflow-hidden">
      ...
      >
        {[...mixesData].reverse().map((mix, index) => (
